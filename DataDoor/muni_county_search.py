...
def custom_google_search_muni(query, municipality, state):
    search_query = f'{query} open "data" AND {municipality} {state} OR site:.gov OR inurl:data OR site:arcgis.com OR site:.org'
